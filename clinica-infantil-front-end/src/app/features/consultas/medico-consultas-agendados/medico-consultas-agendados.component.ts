...
export class MedicoConsultasAgendadosComponent {
  ...
  ngOnInit(): void {
    this.carregarConsultasDoMedicoAgendados();
  }

  carregarConsultasDoMedicoAgendados(pageUrl: string | null = null): void {
    this.isLoading = true;
    this.error = null;
  ...
  onPageChange(pageUrl: string | null): void {
    if (pageUrl) {
      this.carregarConsultasDoMedicoAgendados(pageUrl);
    }
  }
